...
<div class="container">
		<div class="row">
			...
			<form
			action="../StudentHandler/modityCollegestu/${sessionScope.sid }"
			method="get">
			<div class="row">
			
				<div class="col-md-3"><input type="text" name="college" class="form-control" value="${requestScope.college }" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"/> </div>
