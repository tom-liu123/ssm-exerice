...
<nav class="navbar navbar-inverse navbar-expand-lg" role="navigation">
  ...
  <ul class="nav navbar-nav mr-auto">
	...
	<p class="navbar-text navbar-right"style="color:red;">你好！ ${sessionScope.tname} &nbsp;老师   &ensp;&ensp;<a href="/StudentInfo/LoginHandler/teacherlogout" class="navbar-link" href="#">注销</a></p>
	<!--
    <ul class="nav navbar-nav mr-auto">
