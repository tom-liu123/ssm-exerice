		...
		<div class="row">
			...
			<form name="studentquery" action="/StudentInfo/AdminHandler/query/1" method="get">
				<div class="row">
					<div class="col-md-4">
						...
						<!-- 	<option value="col">按市查询</option> -->	
								<option value="pro">按开始日期查询</option>
								<option value="cla">按结束日期查询</option>
							</select>
					...
					<a href="/StudentInfo/AdminHandler/addstu" ><strong>添加学生</strong></a>
				</div>
			...
			<c:forEach var="student" items="${requestScope.slist}">
				<tr>
					...
					<td><a class="btn btn-warning" href="/StudentInfo/AdminHandler/moditystu/${student.sid}">
							修改 </a></td>
