			...
			<div class="col-md-12">
				...
				<div class="row">
						...
						<input type="text" name="sage" value="${student.sage}" class="form-control" maxlength="2"></input>
							...
							<h6>家庭地址  </h6>
							<input type="text" name="classr" value="${student.profession }" class="form-control" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"></input>
							</select>
							
							<h6>开始日期 </h6>
							<input type="text" name="profession" value="${student.college}" class="form-control" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"></input>
							
							<h6>到期日期 </h6>
							<input type="text" name="college" value="${student.classr }" class="form-control" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"></input>
								<h6>添加回复 </h6>
							<input type="text" name="reply" value="${student.reply }" class="form-control" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"></input>
