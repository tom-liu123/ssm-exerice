...
<div class="container">
		<div class="row">
			<div class="col-md-12">
			<h5>视频管理</h5>
			<form name="noticequery" action="/StudentInfo/AdminHandler/queryvideo/1" method="get">
				<div class="row">
					<div class="col-md-4">
						...
						<select name="serc" class="form-control select select-primary select-block mbl">
							...
							<option value="videoid">按视频编号查询</option>
					...
					<a href="/StudentInfo/AdminHandler/addvideo"><strong>添加视频</strong></a>
				</div>
				</form>
			...
			<c:forEach var="video" items="${requestScope.videoList}">
				<tr>
					...
					<td><a class="deleteCss btn btn-default"
						href="/StudentInfo/AdminHandler/deleteVideo/${notice.videoid}"> 删除 </a></td>
				</tr>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/StudentInfo/AdminHandler/queryvideo/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/StudentInfo/AdminHandler/queryvideo/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/StudentInfo/AdminHandler/queryvideo/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/StudentInfo/AdminHandler/queryvideo/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
