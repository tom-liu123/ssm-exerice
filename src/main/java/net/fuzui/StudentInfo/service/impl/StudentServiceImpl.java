...
public class StudentServiceImpl implements StudentService, Serializable {
	...
	@Override
	public int modifyReply(String reply, String sid) {
		// TODO Auto-generated method stub
		return studentMapper.modifyReply(reply,sid);
	}
	...
	@Override
	public int modifyComment(String comment, String sid) {
		// TODO Auto-generated method stub
		return studentMapper.modifyComment(comment, sid);
	}
    /**
     *  修改学生密码
   ...
   @Override
    public int modifyCollegestu(String college, String sid) {
    	// TODO Auto-generated method stub
    	return studentMapper.modifyCollegestu(college, sid);
    }
