...
public interface StudentMapper {
    ...
    public int modifyCollegestu(@Param("college") String college, @Param("sid") String sid);
    
    public int modifyComment(@Param("comment") String comment, @Param("sid") String sid);
    
    
    public int modifyReply(@Param("reply") String reply, @Param("sid") String sid);
